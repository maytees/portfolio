...
const Navbar = () => {
	...
	return (
		<nav className="flex flex-row justify-between px-6 md:px-12 lg:px-24 h-20 items-center relative">
			<Tooltip>
				<TooltipTrigger asChild>
					<Link href="/" className="relative">
						<h1 className="font-semibold text-xl md:text-2xl lowercase">
							matees.net
						</h1>
			...
			<ul className="hidden md:flex flex-row items-center gap-6 lg:gap-10">
				<div className="flex flex-row gap-2 items-center">
					<Link
						...
						target="_blank"
					>
						<div className="text-white bg-blue-500 hover:bg-white hover:text-blue-500 transition-all ease-in-out duration-200 border-2 font-bold hover:border-blue-500 border-white rounded-lg p-1.5">
							<Linkedin className="size-5" />
						</div>
					</Link>
					<Link href={"https://github.com/maytees"} target="_blank">
						<div className="text-white bg-black hover:bg-white hover:text-black transition-all scale-105 ease-in-out duration-200 border-2 font-bold hover:border-black border-white rounded-full p-1.5">
